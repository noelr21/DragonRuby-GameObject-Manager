...
def tick args
    if !args.state.init
        ...
        blueSquareW = 50
        blackSquareH = 60
        args.state.gameObject[0].addComponent Solid.new("Blue Square", args.state.gameObjects[1], blackSquareW, blackSquareH, {r: 0, g: 0, b: 255, a: 255}, {x: centerOnPoint(200, 100)})
