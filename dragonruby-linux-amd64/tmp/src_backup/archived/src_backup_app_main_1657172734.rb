...
def tick args
    if !args.state.init
        ...
        blueSquareW = 50
        blueSquareH = 60
        args.state.gameObject[1].addComponent Solid.new("Blue Square", args.state.gameObjects[1], blueSquareW, blueSquareH, {r: 0, g: 0, b: 255, a: 255}, {x: centerOnPoint(400, blueSquareW), y: centerOnPoint(100, blueSquareH)})
