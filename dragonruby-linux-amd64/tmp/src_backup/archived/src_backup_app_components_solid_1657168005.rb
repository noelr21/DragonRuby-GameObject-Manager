class Solid < RenderedComponent
    ...
    def updateCornerPositions 
        ...
        @cornerPositions.dig(:topRight) = @x + @w
        @cornerPositions.dig(:topRight) = @y + @h
        @cornerPositions.dig(:bottomRight) = @x + @w
        @cornerPositions.dig(:bottomRight) = @y
        @cornerPositions.dig(:bottomLeft) = @x
        @cornerPositions.dig(:bottomLeft) = @y
    end
end
