...
def tick args
    if !args.state.init
        ...
        blackSquareW = 100
        blackSquareH = 100
        args.state.gameObjects[0].addComponent Solid.new("Black Square", args.state.gameObjects[0], 100, 100, {r: 0, g: 0, b: 0, a: 255}, {x: (args.grid.w / 2) - blackSquarew , y: (args.grid.h / 2)})
