class DraggableSolid < Solid
    ...
    def checkCornerHovered
        ...
        if (@args.inputs.mouse.inside_circle?(@cornerPositions[:topLeft], radius))
            ...
            output.push [Utils.centerOnPoint(@cornerPositions[:topLeft][:x], @indicatorSize), Utils.centerOnPoint(@cornerPositions[:topLeft][:y], @indicatorSize), @indicatorSize, @indicatorSize, indicatorColor[:r], indicatorColor[:g], indicatorColor[:b], indicatorColor[:a]]
        else
        ...
        if (@args.inputs.mouse.inside_circle?(@cornerPositions[:topRight], radius))
            ...
            output.push [Utils.centerOnPoint(@cornerPositions[:topRight][:x], @indicatorSize), Utils.centerOnPoint(@cornerPositions[:topRight][:y], @indicatorSize), @indicatorSize, @indicatorSize, indicatorColor[:r], indicatorColor[:g], indicatorColor[:b], indicatorColor[:a]]
        else
        ...
        if (@args.inputs.mouse.inside_circle?(@cornerPositions[:bottomRight], radius))
            ...
            output.push [Utils.centerOnPoint(@cornerPositions[:bottomRight][:x], @indicatorSize), Utils.centerOnPoint(@cornerPositions[:bottomRight][:y], @indicatorSize), @indicatorSize, @indicatorSize, indicatorColor[:r], indicatorColor[:g], indicatorColor[:b], indicatorColor[:a]]
        else
        ...
        if (@args.inputs.mouse.inside_circle?(@cornerPositions[:bottomLeft], radius))
            ...
            output.push [Utils.centerOnPoint(@cornerPositions[:bottomLeft][:x], @indicatorSize), Utils.centerOnPoint(@cornerPositions[:bottomLeft][:y], @indicatorSize), @indicatorSize, @indicatorSize, indicatorColor[:r], indicatorColor[:g], indicatorColor[:b], indicatorColor[:a]]
        else
    ...
    def tick
        ...
        cornerIndicators = checkCornerHovered
