class Solid < RenderedComponent
    ...
    def updateCornerPositions 
        @cornerPositions[:topLeft][:x] = @x
        @cornerPositions[:topLeft][:y] = @y + @h
        @cornerPositions[:topRight][:x] = @x + @w
        @cornerPositions[:topRight][:y] = @y + @h
        @cornerPositions[:bottomRight][:x] = @x + @w
        @cornerPositions[:bottomRight][:y] = @y
        @cornerPositions[:bottomLeft][:x] = @x
        @cornerPositions[:bottomLeft][:y] = @y
    end
end
