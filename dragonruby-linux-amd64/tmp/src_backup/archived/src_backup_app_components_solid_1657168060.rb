class Solid < RenderedComponent
    ...
    def updateCornerPositions 
        @cornerPositions.dig(:topLeft, :x) = @x
        @cornerPositions.dig(:topLeft, :y) = @y + @h
        @cornerPositions.dig(:topRight, :x) = @x + @w
        @cornerPositions.dig(:topRight, :y) = @y + @h
        @cornerPositions.dig(:bottomRight, :x) = @x + @w
        @cornerPositions.dig(:bottomRight, :y) = @y
        @cornerPositions.dig(:bottomLeft, :x) = @x
        @cornerPositions.dig(:bottomLeft, :y) = @y
    end
end
